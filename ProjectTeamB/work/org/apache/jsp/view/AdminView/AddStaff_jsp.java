 ...
 * Generated at: 2023-06-27 06:51:17 UTC
...
if(name==null){ 
      ...
      out.write("/view/VersView/Timeout.jsp\">\n");
      out.write("	");
} 
      out.write("\n");
...
if(staff_lv != null && staff_lv == 1){ 
      ...
      out.write("		<h1>社員追加</h1>\n");
      out.write("		<h3>単体用</h3>\n");
      out.write("		<form method=get name=form1 action=\"");
      out.print( request.getContextPath() );
      out.write("/CmpAddServlet\">\n");
      out.write("			<p>\n");
      out.write("				ユーザー名:&nbsp;&nbsp;&nbsp;<input type=\"text\" name=\"name\" size=\"50\" required>\n");
      out.write("			</p>\n");
      out.write("			<p>\n");
      out.write("				Eメール:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\"\n");
      out.write("					name=\"email\" size=\"50\" required>\n");
      out.write("			</p>\n");
      out.write("			<p>\n");
      out.write("				パスワード:&nbsp;&nbsp;&nbsp;<input type=\"text\" name=\"pass\" size=\"50\" required>\n");
      out.write("			</p>\n");
      out.write("			<p>\n");
      out.write("				権限レベル:&nbsp;&nbsp;&nbsp;\n");
      out.write("			<select name=\"lv\" >\n");
      out.write("			<p>権限レベルを選んでください</p>\n");
      ...
      out.print(request.getContextPath());
      out.write("/CmpAddServlet\">\n");
      out.write("		<p>ファイルの絶対パスを入力してください</p>\n");
      out.write("		\n");
      out.write("		<input type=\"text\" name=\"fpass\" size=\"50\">\n");
      out.write("		<p>\n");
      out.write("			<input type=\"submit\" value=\"追加\">\n");
      out.write("		</p>\n");
      out.write("		</form>\n");
      out.write("		<p>---------------------------------------------------------------------------------------</p>\n");
      out.write("		<form method=\"get\" name=\"form4\" action=\"");
      out.print( request.getContextPath() );
      out.write("/ManagerServlet\">\n");
      out.write("			<p style=\"display: inline\">社員一覧に戻る</p>\n");
      out.write("			<input type=\"submit\" value=\"押す\">\n");
      out.write("		</form>\n");
      out.write("	</div>\n");
      out.write("</body>\n");
      out.write("</html>");
